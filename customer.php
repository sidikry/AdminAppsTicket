                ...
                <div class="item-unique-customer item-customer col-md-12">
                    <div class="row">
                        <div class="content col-md-12">
                            <p class="description">
                                Wanna try to create a customer manually ?
                            </p>
                    ...
                    <div class="row">
                        <div class="content col-md-12">
                            ...
                            <div class="wrap-picture">
                                <img class="primary-user-picture-circle" src="<?php echo $print_data_user_profile['url_photo_profile']; ?>" alt="">
                            </div>
                            <p class="title">
                            ...
                            <a href="customer_detail.php?username=<?php echo $print_data_user_profile['username'];?>" class="btn btn-view btn-primary btn-primary-tiketsaya">View
                                Profile</a>
                        </div>
                    </div>
                </div>
